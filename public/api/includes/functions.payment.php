                ...
                else
                {
                    ...
                    if ( isset($result) && !empty($result) )
                    {
                        ...
                        try 
                        {
                            ...
                            $base_queryres = ' INSERT INTO tbl_payments (OrderId, TotalAmount, OwnerId, CardNumber, CardExpiryDate, CardDetails, CardStripTokan, PaymentDate, CreatedOn) VALUES("' . $orderid . '" , "' . $totalamount . '" ,"' . $Owner_Id . '"  ,"-" , "-", "' . $description . '" , "'. $stripeToken .'", "'. $paymentdate .'", "'. $CreatedOn .'") ';
